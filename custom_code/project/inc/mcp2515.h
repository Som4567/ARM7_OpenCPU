...
typedef enum c_CANCTRL_REQOP_MODE
{
...
static const uint32_t SPI_CLOCK = 10000; // 10MHz
...
ERROR setBitrates(const CAN_SPEED canSpeed, const CAN_CLOCK canClock);
